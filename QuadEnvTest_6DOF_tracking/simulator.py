...
plt.title('p,q and r')
plt.legend(['p', 'q', 'r'])
plt.savefig('SimulationResults_1103/Angular_velocity_2.jpg')
...
plt.title('u,v and w')
plt.legend(['u', 'v', 'w'])
plt.savefig('SimulationResults_1103/Velocity_2.jpg')
...
plt.title('X,Y and Z')
plt.legend(['X', 'Y', 'Z'])
plt.savefig('SimulationResults_1103/Position_2.jpg')
...
plt.savefig('SimulationResults_1103/Euler_2.jpg')
...
plt.savefig('SimulationResults_1103/reward_2.jpg')
...
plt.savefig('SimulationResults_1103/action_2.jpg')
...
#ax.ylabel('H==-Z')
#ax.title('Trajectory')
plt.savefig('SimulationResults_1103/Trajectory_2.jpg')
...
#plt.xlim(-2.2, 2.2)
#plt.ylim(-2.2, 2.2)
plt.legend(['Traiettoria'])
plt.title('plane X,Y ')

plt.savefig('SimulationResults_1103/Position_2D_2.jpg')
...
for count in range(int(env.elapsed_time_steps/8)):
  ...
  fig2save = 'SimulationResults_1103/Orientation/2trajectory_' + str(count) + '.jpg'
